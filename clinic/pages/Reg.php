...
<div id="NavBar">
	...
	<ul>
<li><a href="http://localhost/clinic/pages/index.php">HOME</a href="home.php"></li>
                    ...
                    <form  class="form-horizontal" method="post" >
                        ...
                        <div id="div_id_As" class="form-group required">
                            ...
                            <div class="controls col-md-8 "  style="margin-bottom: 10px">
                                ...
                                <label class="radio-inline"> <input type="radio" name="As" id="id_As_2" value="CI"  style="margin-bottom: 10px">Name </label>
